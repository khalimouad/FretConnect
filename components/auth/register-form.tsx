  ...
  if (submitted === "company") {
    return (
      <Card className="p-8 text-center">
        ...
        <h2 className="mt-4 text-xl font-bold text-brand-950">
        ...
        <Link
          href={`/${locale}`}
          className="mt-6 inline-block rounded-lg bg-brand-900 px-5 py-2.5 text-sm font-semibold text-white hover:bg-brand-800"
        >
          {dict.common.back}
        </Link>
      </Card>
        ...
        {(
          ...
          <button
            ...
            className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-sm font-semibold transition-colors ${
              tab === t.key
                ? "bg-white text-brand-950 shadow-card"
      ...
      <Card className="mt-4 p-6">
        {tab === "user" ? (
          ...
          >
            ...
            <p className="text-xs text-slate-400">{dict.auth.userNote}</p>
          ...
          >
            ...
            <p className="rounded-lg bg-amber-50 p-3 text-xs leading-relaxed text-amber-800 ring-1 ring-inset ring-amber-200">
        ...
        <p className="mt-4 text-center text-sm text-slate-500">
          ...
          <Link href={`/${locale}/login`} className="font-semibold text-accent-600 hover:underline">
            {dict.common.login}
          </Link>
        </p>
      </Card>
