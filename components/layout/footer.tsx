...
export function Footer({ locale, dict }: { locale: Locale; dict: Dictionary }) {
  return (
    <footer className="border-t border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-500 dark:text-slate-400">
            <li>
              <Link href={`/${locale}/search`} className="hover:text-brand-800 dark:hover:text-brand-300">
                {dict.nav.findFreight}
              </Link>
            </li>
            <li>
              <Link href={`/${locale}/pricing`} className="hover:text-brand-800 dark:hover:text-brand-300">
                {dict.nav.pricing}
              </Link>
            </li>
            <li>
              <Link href={`/${locale}/register`} className="hover:text-brand-800 dark:hover:text-brand-300">
      ...
      <div className="border-t border-slate-100 py-4 text-center text-xs text-slate-400 dark:border-slate-900 dark:text-slate-500">
